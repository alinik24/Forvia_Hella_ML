from src.data_preprocessing.config import INPUT_FILE_BOOKINGS_SL, OUTPUT_FILE_BOOKINGS_SL_b
from src.data_preprocessing.utils.balance_utils import balance_by_state_per_serial


def main():
    balance_by_state_per_serial(
        input_main_path=INPUT_FILE_BOOKINGS_SL,
        output_main_path=OUTPUT_FILE_BOOKINGS_SL_b,
