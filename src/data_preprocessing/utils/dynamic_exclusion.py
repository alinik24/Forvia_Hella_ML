...
class DynamicExclusionPipeline:
    ...
    def _load_summary(self):
        ...
        self.df_summary["serial_number_id"] = self.df_summary["Serial Number ID"]
    ...
    def _load_source(self):
        ...
        table = pq.read_table(self.source_file, columns=["serial_number_id", "book_state", "station_desc"])
        self.df_source = table.to_pandas()
    ...
    def _save_outputs(self):
        ...
        pd.DataFrame(self.anomalous_serials, columns=["Anomalous Serial Number ID"]).to_csv(
    ...
    def _generate_report(self):
        ...
        def add_metrics(label, df):
            ...
            metrics["Value"] += [len(df), df["serial_number_id"].nunique(), df["station_desc"].nunique()]
